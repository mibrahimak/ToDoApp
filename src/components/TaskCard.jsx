      ...
      <div className='flex items-center gap-2 shrink-0'>
        <button
          ...
          className={`px-3.5 py-2 text-xs sm:text-sm font-bold text-white rounded-xl shadow-sm transition-all duration-200 ${
            task.completed
              ? 'bg-gradient-to-br from-emerald-500 to-teal-600 hover:from-emerald-600 hover:to-teal-700 shadow-emerald-200/50'
              : 'bg-gradient-to-br from-slate-600 to-slate-800 hover:from-slate-700 hover:to-slate-900'
          }`}
        >
